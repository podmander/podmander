...
After modifying tests, run `mise run test` before handing the work off. Expected
assertion failures are permitted during Red, but compilation and GNAT formatting
diagnostics must be clean.
