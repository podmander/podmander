...
package body Podmander.Agent.Podman is
   ...
   -- a Deployment_Result carrying the step's Result_Code, Service_Name,
   -- and Error_Message.
   function Run_Systemctl_Step
     (Args           : HC.Argument_List;
      Step_Label     : String;
      Service_Name   : String;
      Failure_Result : out Deployment_Result) return Boolean
   is
   ...
   function Install_Quadlet
     (Service_Name : String; Quadlet : String) return Deployment_Result
   is
      ...
      Step_Failure_Result : Deployment_Result;
   begin
