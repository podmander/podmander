...
package body Podmander.Messages.Registration_Responses is
   ...
   overriding
   procedure Encode (Self : Registration_Response; Msg : in out CZMQ.Messages.Message) is
   begin
   ...
   overriding
   procedure Dispatch_To (Self : Registration_Response; H : in out Message_Handler'Class) is
   ...
   begin
      ...
      return Registration_Response'(Node_Id => To_Unbounded_String (Msg.Pop_String));
   end Decode_Impl;
