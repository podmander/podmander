...
--  First Available scheduling strategy: selects the first node with a
--  connected (Registered) agent. Returns Present => False when no eligible
--  node exists. Stateless; share the package-level Instance constant.
