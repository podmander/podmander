...
package body Podmander.Generators.Quadlet_Tests is
   ...
   overriding
   function Name (T : Quadlet_Test) return AUnit.Message_String
   ...
   begin
      Assert (Ada.Strings.Fixed.Index (Output, "[Container]") > 0, "Output should contain [Container] section");
        ...
        (Name          => Null_Unbounded_String,
         ...
         Env           =>
           [1      => (Key => To_Unbounded_String ("FOO"), Value => To_Unbounded_String ("bar")),
            others => (Key => Null_Unbounded_String, Value => Null_Unbounded_String)],
         Env_Count     => 1,
         Ports         => [others => (Host => 1, Container => 1)],
         Ports_Count   => 0,
         Volumes       => [others => (Host => Null_Unbounded_String, Container => Null_Unbounded_String)],
   ...
   procedure Test_Render_Multiple_Env (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Config : constant Service_Definition :=
        (Name          => Null_Unbounded_String,
         ...
         Env           =>
           [1      => (Key => To_Unbounded_String ("FOO"), Value => To_Unbounded_String ("bar")),
            2      => (Key => To_Unbounded_String ("BAZ"), Value => To_Unbounded_String ("qux")),
            others => (Key => Null_Unbounded_String, Value => Null_Unbounded_String)],
         Env_Count     => 2,
         Ports         => [others => (Host => 1, Container => 1)],
         Ports_Count   => 0,
   ...
   procedure Test_Render_Single_Port (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Config : constant Service_Definition :=
        (Name          => Null_Unbounded_String,
         ...
         Env           => [others => (Key => Null_Unbounded_String, Value => Null_Unbounded_String)],
         Env_Count     => 0,
         Ports         => [1 => (Host => 8080, Container => 80), others => (Host => 1, Container => 1)],
         Ports_Count   => 1,
         Volumes       => [others => (Host => Null_Unbounded_String, Container => Null_Unbounded_String)],
         Volumes_Count => 0,
         Description   => Null_Unbounded_String,
   ...
   procedure Test_Render_Single_Volume (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Config : constant Service_Definition :=
        (Name          => Null_Unbounded_String,
         ...
         Ports_Count   => 0,
         Volumes       =>
           [1      => (Host => To_Unbounded_String ("/data"), Container => To_Unbounded_String ("/data")),
   ...
   begin
      Assert (Ada.Strings.Fixed.Index (Output, "[Container]") > 0, "Output should contain [Container] section");
      Assert (Ada.Strings.Fixed.Index (Output, "Image=myapp:latest") > 0, "Output should contain Image=myapp:latest");
      Assert (Ada.Strings.Fixed.Index (Output, "Environment=FOO=bar") > 0, "Output should contain Environment=FOO=bar");
      Assert (Ada.Strings.Fixed.Index (Output, "Environment=BAZ=qux") > 0, "Output should contain Environment=BAZ=qux");
      Assert (Ada.Strings.Fixed.Index (Output, "PublishPort=8080:80") > 0, "Output should contain PublishPort=8080:80");
      Assert (Ada.Strings.Fixed.Index (Output, "PublishPort=443:443") > 0, "Output should contain PublishPort=443:443");
   ...
   procedure Test_Render_Description_Present (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Output : constant String := Render (Config);
   begin
      Assert (Ada.Strings.Fixed.Index (Output, "[Unit]") > 0, "Output should contain [Unit] section");
      Assert
        (Ada.Strings.Fixed.Index (Output, "Description=My web app") > 0,
   ...
   procedure Test_Render_WantedBy_Specified (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Output : constant String := Render (Config);
   begin
      Assert (Ada.Strings.Fixed.Index (Output, "[Install]") > 0, "Output should contain [Install] section");
      Assert
        (Ada.Strings.Fixed.Index (Output, "WantedBy=multi-user.target") > 0,
   ...
   procedure Test_Render_Full_Sections (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Config        : constant Service_Definition :=
        (Name          => Null_Unbounded_String,
         ...
         WantedBy      => To_Unbounded_String ("multi-user.target"));
      Output        : constant String := Render (Config);
      Unit_Pos      : constant Natural := Ada.Strings.Fixed.Index (Output, "[Unit]");
      Container_Pos : constant Natural := Ada.Strings.Fixed.Index (Output, "[Container]");
      Install_Pos   : constant Natural := Ada.Strings.Fixed.Index (Output, "[Install]");
   begin
      Assert (Unit_Pos > 0, "Output should contain [Unit] section");
      Assert (Container_Pos > 0, "Output should contain [Container] section");
      Assert (Install_Pos > 0, "Output should contain [Install] section");
      Assert (Unit_Pos < Container_Pos, "[Unit] section should appear before [Container]");
   ...
   function Read_File (Path : String) return String is
      File    : Ada.Text_IO.File_Type;
      Content : Ada.Strings.Unbounded.Unbounded_String := Ada.Strings.Unbounded.Null_Unbounded_String;
   begin
   ...
   procedure Test_Golden_Minimal (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Config : constant Service_Definition :=
        (Name          => Null_Unbounded_String,
         ...
         Description   => Null_Unbounded_String,
         WantedBy      => Null_Unbounded_String);
      Golden : constant String := Read_File ("tests/fixtures/quadlet/minimal.container") & ASCII.LF;
      Output : constant String := Render (Config);
   begin
   ...
   procedure Test_Golden_Full (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Config : constant Service_Definition :=
        (Name          => Null_Unbounded_String,
         ...
         Description   => To_Unbounded_String ("My web app"),
         WantedBy      => To_Unbounded_String ("multi-user.target"));
      Golden : constant String := Read_File ("tests/fixtures/quadlet/full.container") & ASCII.LF;
      Output : constant String := Render (Config);
   begin
      ...
      Config : constant Service_Definition :=
        (Name          => Null_Unbounded_String,
         ...
         Env           =>
           [1      => (Key => To_Unbounded_String ("FOO"), Value => To_Unbounded_String ("bar")),
            2      => (Key => To_Unbounded_String ("BAZ"), Value => To_Unbounded_String ("qux")),
            3      => (Key => To_Unbounded_String ("APP_ENV"), Value => To_Unbounded_String ("production")),
            others => (Key => Null_Unbounded_String, Value => Null_Unbounded_String)],
         Env_Count     => 3,
         Ports         => [others => (Host => 1, Container => 1)],
         Ports_Count   => 0,
         ...
         WantedBy      => Null_Unbounded_String);
      Golden : constant String := Read_File ("tests/fixtures/quadlet/multi-env.container") & ASCII.LF;
      Output : constant String := Render (Config);
   begin
   ...
   procedure Test_Golden_Multi_Port (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Config : constant Service_Definition :=
        (Name          => Null_Unbounded_String,
         ...
         WantedBy      => Null_Unbounded_String);
      Golden : constant String := Read_File ("tests/fixtures/quadlet/multi-port.container") & ASCII.LF;
      Output : constant String := Render (Config);
   begin
   ...
   begin
      Register_Routine (T, Test_Render_Minimal'Access, "Render minimal service with only Image set");
      Register_Routine (T, Test_Render_Single_Env'Access, "Render service with one environment variable");
      Register_Routine (T, Test_Render_Multiple_Env'Access, "Render service with two environment variables");
      Register_Routine (T, Test_Render_Single_Port'Access, "Render service with one port mapping");
      Register_Routine (T, Test_Render_Multiple_Ports'Access, "Render service with two port mappings");
      Register_Routine (T, Test_Render_Single_Volume'Access, "Render service with one volume mapping");
      Register_Routine (T, Test_Render_Full_Container'Access, "Render full container with all field types");
      Register_Routine (T, Test_Render_Description_Present'Access, "Render service with Description present");
      Register_Routine (T, Test_Render_Description_Empty'Access, "Render service with empty Description");
      Register_Routine (T, Test_Render_WantedBy_Specified'Access, "Render service with explicit WantedBy");
      Register_Routine (T, Test_Render_WantedBy_Default'Access, "Render service with default WantedBy");
      Register_Routine (T, Test_Render_Full_Sections'Access, "Render service with all sections in correct order");
      Register_Routine (T, Test_Write_File_Creates_File'Access, "Write_File creates a .container file on disk");
      Register_Routine
        (T, Test_Write_File_Creates_Directory'Access, "Write_File creates output directory if it does not exist");
      Register_Routine (T, Test_Write_File_Content_Matches_Render'Access, "Write_File content matches Render output");
      Register_Routine (T, Test_Golden_Minimal'Access, "Golden minimal: Image only, no Description");
      Register_Routine (T, Test_Golden_Full'Access, "Golden full: Description, Image, 2 env, 2 ports, 1 volume");
      Register_Routine (T, Test_Golden_Multi_Env'Access, "Golden multi-env: 3 environment variables");
      Register_Routine (T, Test_Golden_Multi_Port'Access, "Golden multi-port: 3 port mappings");
   end Register_Tests;
