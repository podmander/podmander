...
package body Podmander.Enrollment_Tests is
   ...
   overriding function Name
     (T : Enrollment_Test) return AUnit.Message_String
   is (AUnit.Format ("Enrollment Token Parser"));

   overriding procedure Register_Tests (T : in out Enrollment_Test);
   ...
   begin
      Register_Routine
        (T, Test_Roundtrip_Recovers_Public_Key_And_Secret'Access,
         "Generate then Parse recovers both halves of the token");
      Register_Routine
        (T, Test_Wrong_Prefix_Raises'Access,
