...
package body Podmander.Logging_Tests is
   ...
   overriding function Name
     (T : Logging_Test) return AUnit.Message_String
   is (AUnit.Format ("Logging"));

   overriding procedure Register_Tests (T : in out Logging_Test);
   ...
   overriding procedure Register_Tests (T : in out Logging_Test) is
      use AUnit.Test_Cases.Registration;
   begin
      Register_Routine
        (T, Test_Debug_Suppressed_At_Info'Access,
         "Debug suppressed at Info");
      Register_Routine
        (T, Test_Info_Emitted_At_Info'Access,
         "Info emitted at Info");
      Register_Routine
        (T, Test_Warning_Emitted_At_Info'Access,
         "Warning emitted at Info");
      Register_Routine
        (T, Test_All_Levels_At_Debug'Access,
         "All levels at Debug");
      Register_Routine
        (T, Test_Critical_Emitted_At_Critical'Access,
         "Critical at Critical level");
      Register_Routine
        (T, Test_Error_Suppressed_At_Critical'Access,
